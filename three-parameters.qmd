...
<!-- DK: Preceptor Table is always capitalized and has no missing values. Star numbers in the Preceptor Table which will never be oberseved. -->

<!-- DK: Preceptor Table rows in Population Table have no outcomes or covariates most of the time. -->

<!-- DK: Plot ggplot(data = trains, aes(x = age, y = income)) + geom_point() instead of income versus age histogram. -->
...
We should always be cautious about our inferences. Our assumptions are never true. 

<!-- One sentence per assumption. -->

Our stated inferences almost certainly underestimate the true uncertainty of the world. Stay cautious my friends.
