...
<!-- DK: Always need to ask specify the moment in time to which the Preceptor Table refers. The original question will almost never specify this, although the normal answer is often "now" or "today." Ask this question as part of the what is the outcome question. -->

<!-- DK: In each case, make the "refined" question explicit right before creating the Preceptor Table. -->

<!-- DK: In the Validiy section, always discuss how we need to refine the question further in order to answer it, because variables do not come out of this air. -->

<!-- DK: Capitalize Population Table. -->
...
<!-- DK: Add discussio about how the questions, like always, is in exact. Who are we talking about. Let's assume it is all adults in the US in 2012. In fact, the "what are the units" paragraphs always need this discussion, otherwise we can't create a Preceptor Table. And, in addition to units, you need to discuss time. When are we asking this question? Assume it is July 1, 2012.  -->
...
<!-- DK: Fix this. A "treatment" is just a covariate which, first, we *can* manipulate and, second, we *need* to manipulate, at least in theory, to answer the question. -->
...
<!-- DK: Make table predictive. -->

```{r}
#| echo: false
tibble(ID = c("1", "2", "...", "10", "11", "...", "N"),
       attitude_yes_liberal = c("3*", "7", "...", "10*", "4", "...", "6"),
       attitude_no_liberal = c("8", "2*", "...", "5", "15*", "...", "7*"),
       income = c("150000", "50000", "...", "65000", "35000", "...", "78000")) |>
  gt() |>
  tab_header(title = "Preceptor Table") |> 
  cols_label(ID = md("ID"),
...
<!-- DK: Change this plot to use liberal and income. -->
...
<!-- DK: Sentence should be something about it not being clear how strong the connection is between liberal and income. -->
