...
<!-- `partyDemocrat` corresponds to $\beta_1$, the average age of Democrats in the population. `partyRepublican` corresponds to $\beta_2$, the average age of Republicans in the population.  -->

<!-- DK: We can keep/edit the below comments since many of these facts can be determined directly from the fitted object. -->

We can display the fitted values of the parameters in a pleasing table:

<!-- MT: need to remove the democrat from below and clean up table -->
