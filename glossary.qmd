...
<!-- DK: Do we build the final paragraph section by section, so that the Courage section, for example, includes the key sentence from the Wisdom and Justice sections, even though that this a repeat? Yes? -->
