...
This package is fairly simple and should install without any problems. Many other new packages will be installed as well. Copy and paste the following to the R Console:
