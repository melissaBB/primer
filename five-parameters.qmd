...
<!-- DK: Perhaps use as a good example of how the estimated posterior is not the true posterior, Preceptor's Posterior, because of the assumptions we are making are never completely true. Add a paragrpah in Temperance about this fact. DONE-->

<!-- DK: Do we really believe the posterior for male/female expected years lived? No! Or, at the very least, we are suspicious. Discuss the importance of prior knowledge and "reality checks" in Temperance or, perhaps better, in election_age + sex model section.  DONE-->

<!-- DK: Add posterior_predictive checks. Belongs at the end of the courage section. DONE-->

<!-- DK: Get rid of warnings with size aesthetic in plots. DONE-->

<!-- DK: For each model, we need the math, the code and the printed out fitted model. DONE-->
...
<!-- Add Commentary across all model checks -->

### election_age

<!-- DK: Add a nice graphic with the fitted line, like we have in the next section. DONE-->
...
<!-- DK: Is the above right? Yes. DONE-->
...
<!-- DK: Make question consistent with one you started with. DONE-->
