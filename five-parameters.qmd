...
<!-- DK: Add Preceptor Table for first question. -->

<!-- DK: ch10 should be ch7_a and ch7_b -->

<!-- DK: Hide the code, as you see fit. -->
...
tibble(source = c("...", "Data", "Data", "...", 
  ...
  tab_spanner(label = "Covariates", columns = c(sex, won, election_age))
```
...
```{r}
fit_5 <- stan_glm(data = filter(ch10_b, close_race),
