...
<!-- DK: Perhaps use as a good example of how the estimated posterior is not the true posterior, Preceptor's Posterior, because of the assumptions we are making are never completely true. Add a paragrpah in Temperance about this fact. -->

<!-- DK: Do we really believe the posterior for male/female expected years lived? No! Or, at the very least, we are suspicious. Discuss the importance of prior knowledge and "reality checks" in Temperance or, perhaps better, in election_age + sex model section.  -->

<!-- DK: Add posterior_predictive checks. Belongs at the end of the courage section. -->

<!-- DK: Get rid of warnings with size aesthetic in plots. -->

<!-- DK: For each model, we need the math, the code and the printed out fitted model. -->
...
tibble(ID = c("Candidate 1", "Candidate 2", "...", "Candidate 10", "Candidate 11", "...", "Candidate N"),
       ...
       year_elected = c("1967", "2012", "...", "2012", "2015", "...", "2015"),
...
<!-- DK: Add a nice graphic with the fitted line, like we have in the next section. -->
...
<!-- DK: Make question consistent with one you started with. -->
...
<!-- DK: Do males live longer than females, even when both of 62? That is surprising! Discuss again, even though we discussed above. This is sort of a posterior predictive check using uour knowledge of the world. -->
