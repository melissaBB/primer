...
<!-- DK: Show the code for fitting and printing models, and for any other code chunks that are small/important. -->
...
<!-- DK: Perhaps add summary paragraph. Mention the questions in the introduction. Then sentence or two summary about Cardinal Virtues. -->
...
<!-- DK: Start with less precise version of the question, and then refine it. -->
...
First, do we need a **causal** or **predictive** model? In our question above we have a predictive model as we only have one outcome which is the person's longevity.
...
<!-- DK: Pick units, either all candidates from 2000 through 2023, or all candidates in the 2024 election. -->
