...
<!-- DK: I have fixed the most egregious disagreements between our revised Cardinal Virtues process and what was here before. However, the end of this chapter is still a mess! Maybe that is OK because it is trying to connect to all the theory we had in the Probability Chapter. We are also doing a bit of CYA to explain why, for the rest of the book, we are doing things our way. Still . . . -->
...
<!-- DK: This paragraph could be improved to be more like other chapters. Shouldn't every introduction mention the key concepts of the book: the four Cardinal Virtues and the assumptions which link them together? -->
...
knitr::include_graphics("one-parameter/images/sampling_bowl_1.jpg")
```
...
knitr::include_graphics("one-parameter/images/sampling_bowl_2.jpg")
```
...
knitr::include_graphics("one-parameter/images/sampling_bowl_3_cropped.jpg")
```
...
knitr::include_graphics("one-parameter/images/tactile_3_a.jpg")
```
...
knitr::include_graphics("one-parameter/images/tactile_3_c.jpg")
```
...
knitr::include_graphics("one-parameter/images/sample_bernie.png")
```
...
knitr::include_graphics("one-parameter/images/three_shovels.png")
```
...
knitr::include_graphics("one-parameter/images/variance_everywhere_meme.jpeg")
```
...
#|   be on a problem set.'
knitr::include_graphics("one-parameter/images/meme_math.png")
```
...
#| fig.align: center
knitr::include_graphics("one-parameter/images/old_man_SE.png")
```
...
knitr::include_graphics("one-parameter/images/yoda.png")
```
...
#|   right now!
knitr::include_graphics("one-parameter/images/cant_breathe_sponge.png")
```
...
#| fig.align: center
knitr::include_graphics("one-parameter/images/final_preceptor.png")
```
...
knitr::include_graphics("one-parameter/images/here_we_go.png")
```
...
<!-- DK: Could expand on this point, or move it to later. -->
...
<!-- DK: Cut all this? No need to explain why some other approach is wrong. Just say that our approach is correct. -->

The Cardinal Virtues may seem tedious, but we use them for good reason. In Wisdom we determined what data we need to answer our question, and in Justice we analyzed whether or not the data we have can answer our question. If we had skipped these steps, we would be at risk of creating models with "bad data" in Courage and Temperance, and of then drawing misleading conclusions. 
...
The total number of red beads selected in a sample of 20 beads, $R_i$, is modeled by a binomial distribution with $n = 20$ observations and an unknown probability $\rho$ of the proportion of red beads in the urn.
...
<!-- DK: Delete all this? Make it just two paragraphs? Or add in the Cardinal Virtue concerns? Yes! Switch to recent poll. -->

Let's now switch gears to a more realistic sampling scenario: a poll. In practice, pollsters do not take 1,000 repeated samples as we did in our virtual sampling activities, but rather take only a *single sample* that's as large as possible.
