...
Make things more like later chapters in terms of the Preceptor Table, Population Table and key assumptions. Consider dropping the Simple models sections. Add other stuff?
...
A **Preceptor Table**^[The term Preceptor Table is, perhaps unsurprisingly, unique to this textbook. We hope you find it useful.] is the smallest possible table with rows and columns such that, if none of the data is missing, then the thing we want to know is easy to calculate. Consider:
