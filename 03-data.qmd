...
<!-- Do we need a section on working with APIs? Not really that important. Not sure I can remember the last student who used an API. Does not seem to be included in R4DS.  If we add this, should follow the httr2 docs.  -->
...
And finally, we looked at how we can pull data from websites through webscraping, letting us pull data from the internet quickly and easily. This lets us find data for our projects and load it into our R session without having to create it ourselves or download a file from the internet.
